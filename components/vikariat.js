      ...
      <div className="grid grid-cols-2 md:grid-cols-3 grid-flow-row gap-4 items-center mt-4">
        ...
        {person4 !== undefined ? (
          <ProfileCard
            ...
            name={person4.name}
            title={"Vikariátní zástupce"}
            jpgPath={person4.jpgPath}
            webpPath={
              person4.webpPath === undefined
                ? `${person4.jpgPath}`.replace(".jpg", ".webp")
                : person4.webpPath
            }
            altText={`Profilová fotka zástupce pro mládež ${person4.name}`}
          />
        ) : null}
        {loader1 !== undefined ? (
          <ProfileCard
            ...
            jpgPath={loader1.jpgPath}
            webpPath={
              loader1.webpPath === undefined
                ? `${loader1.jpgPath}`.replace(".jpg", ".webp")
                : loader1.webpPath
            }
