...
export function game() {
  ...
  function update() {
    ...
    gameSpeedUp();
    // clear only half of images to speed up rendering
    left
      ? (board.context.clearRect(0, 0, board.width / 2, board.height),
        (left = false))
      : (board.context.clearRect(board.width / 2, 0, board.width, board.height),
        (left = true));
