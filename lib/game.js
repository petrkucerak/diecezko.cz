  ...
  function moveGround() {
    ...
    if (donut.isVisible) {
      ...
      if (
        ...
        piegon.animationNo = 11;
        gameScore.innerText = parseInt(gameScore.innerText) + 2;
      }
    }
    if (meat.isVisible) {
      meat.x -= 1;
    ...
    if (burger.isVisible) {
      ...
      if (
        ...
        piegon.animationNo = 11;
        gameScore.innerText = parseInt(gameScore.innerText) + 3;
      }
    }
    if (pizza.isVisible) {
      pizza.x -= 1;
    ...
    if (star.isVisible) {
      ...
      if (
        ...
        // piegon.animationNo = 11;
        gameScore.innerText = parseInt(gameScore.innerText) + 15;
      }
    }
  }
